...
<body>
    <header class="main">
        <nav>
            ...
            <ul class="menu">
                <li><a href="index2.php">Beranda</a></a></li>
    ...
    <div class="booking-heading">
        ...
        <p>Isikan form dibawah berikut, untuk booking kendaraan yang ingin disewa.</p>
    </div>
    <div class="form-container">
        <form action="userinformation.php" method="post">
            <select name="vehicle" id="vehicle">
                <option value="selectvehicle">Pilih Kendaraan</option>
                <option value="motor">Motor</option>
                <option value="mobil">Mobil</option>
            </select>
            <input type="text" name="user" placeholder="Nama Lengkap"/>
            <input type="text" name="alamat" placeholder="Alamat"/>
            <textarea name="pesan" placeholder="Tuliskan pesan anda disini.........."></textarea>
            <button class="main-btn booking-btn" type="submit">Booking</button>
        </form>
    </div>
    </section>
